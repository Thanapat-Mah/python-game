...
class ControlPanel:
	def __init__(self, screen, game, background_color=Color.white):
		...
		self.time = 0
		self.playstop_bt = Button(x=self.x+280, y=255, text='play', font=Font.comic_small, text_color=Color.white, background_color=Color.green)
		...
		self.cellsize_bt = Button(x=self.x+290, y=125, text=str(game.cell_size), font=Font.comic_small, text_color=Color.white, background_color=Color.black)
		self.speed_bar = SlideBar(x=self.x+50, y=240, name='Time period', font=Font.comic_small, text_color=Color.black, bar_lenght=200,
	...
	def draw_time(self):
		...
		self.display.blit(time_label, (self.x+50, 20))
		self.display.blit(time, (self.x+50+time_label.get_width(), 20))
